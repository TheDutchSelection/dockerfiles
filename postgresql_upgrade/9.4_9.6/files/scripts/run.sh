...
cp -p /etc/postgresql/9.6/main/postgresql_9_6_template.conf /etc/postgresql/9.6/main/postgresql.conf
...
sed -i "s/##data_directory##/$escaped_old_data_directory/g" /etc/postgresql/9.4/main/postgresql.conf
sed -i "s/##data_directory##/$escaped_data_directory/g" /etc/postgresql/9.6/main/postgresql.conf
